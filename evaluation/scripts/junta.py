    ...
    for json_file in json_files:
        ...
        aggregated[pid] = {
            "result": {
                ...
                "vítimas": {
                    # FIX: aceita vitimas com ou sem acento como chave de entrada
                    "vitimas": normalize_people(
                        data.get("vitimas") or data.get("vítimas"), "vitimas"
                    )
                },
                "suspeitos": {
                    # FIX: segundo arg deve ser "Suspeitos" (maiúsculo) — chave do schema Pydantic
